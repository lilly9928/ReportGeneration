...
def compute_metrics(predicted_imps_lst, predicted_fins_lst, image_ids_lst, args):
    ...
    if args.imp_fin_only:
        ...
        imp_fin_bleu, imp_fin_rouge, imp_fin_cider = _define_metrics(gt_imp_fin_dic, pre_imp_fin_dic)
        # print('Impression + Finding: bleu = %s, meteor = %s, rouge = %s, cider = %s' % (
        #     imp_fin_bleu, imp_fin_meteor, imp_fin_rouge, imp_fin_cider))
        print('Impression + Finding: bleu = %s, rouge = %s, cider = %s' % (
            imp_fin_bleu, imp_fin_rouge, imp_fin_cider))
    ...
    return imp_fin_bleu, imp_fin_rouge, imp_fin_cider
