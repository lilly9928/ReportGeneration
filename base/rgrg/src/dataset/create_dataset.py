...
from base.rgrg.src.dataset.constants import ANATOMICAL_REGIONS, IMAGE_IDS_TO_IGNORE, SUBSTRINGS_TO_REMOVE
import base.rgrg.src.dataset.section_parser as sp
from base.rgrg.src.path_datasets_and_weights import path_chest_imagenome, path_mimic_cxr, path_mimic_cxr_jpg, path_full_dataset
...
def get_rows(dataset: str, path_csv_file: str, image_ids_to_avoid: set) -> list[list]:
    ...
    with open(path_csv_file) as csv_file:
        ...
        for row in tqdm(csv_reader, total=total_num_rows):
            ...
            chest_imagenome_scene_graph_file_path = os.path.join(path_chest_imagenome, "silver_dataset", "scene_graph", "scene_graph", image_id) + "_SceneGraph.json"
