...
from base.rgrg.src.dataset.constants import ANATOMICAL_REGIONS
from base.rgrg.src.full_model.custom_collator import CustomCollator
from base.rgrg.src.full_model.custom_dataset import CustomDataset
from base.rgrg.src.full_model.evaluate_full_model.evaluate_model import (
    update_object_detector_metrics,
    update_region_abnormal_metrics,
    update_region_selection_metrics,
)
from base.rgrg.src.full_model.evaluate_full_model.evaluate_language_model import (
...
from base.rgrg.src.full_model.report_generation_model import ReportGenerationModel
from base.rgrg.src.full_model.train_full_model import get_tokenizer
from base.rgrg.src.path_datasets_and_weights import path_full_dataset, path_runs_full_model, path_test_set_evaluation_scores_txt_files

# specify the checkpoint you want to evaluate by setting "RUN" and "CHECKPOINT"
RUN = 38
CHECKPOINT = "D:/github/ReportGeneration/base/rgrg/full_model_checkpoint_val_loss_19.793_overall_steps_155252.pt"
