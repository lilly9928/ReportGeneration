...
from base.rgrg.src.full_model.evaluate_full_model.evaluate_model import evaluate_model
...
from base.rgrg.src.path_datasets_and_weights import path_full_dataset, path_runs_full_model
