...
def model_test(img_en_path, imp_de_path, fin_de_path, args):
...
if __name__ == '__main__':
    ...
    assert num_ckpt == 15 or num_ckpt == 18

    num_run = "test"
    predicted_imps_lst, predicted_fins_lst, image_id_list = model_test(img_en_path, imp_de_path, fin_de_path, args)
